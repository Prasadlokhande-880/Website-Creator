...
const cards = (editor) => {
  ...
  editor.BlockManager.add("card-block-1", {
    label: `
...
<p class="font-normal text-gray-700 dark:text-gray-400">Here are the biggest enterprise technology acquisitions of 2021 so far, in reverse chronological order.</p>
  ...
  editor.BlockManager.add("card-block-2", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `
...
<a href="#" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
  ...
  editor.BlockManager.add("card-block-3", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `
...
<a href="#" class="inline-flex font-medium items-center text-blue-600 hover:underline">
  ...
  editor.BlockManager.add("card-block-4", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `
...
<div class="p-5">
  ...
  editor.BlockManager.add("card-block-5", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `
...
<div class="flex flex-col justify-between p-4 leading-normal">
  ...
  editor.BlockManager.add("card-block-6", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `
...
<div class="flex flex-col items-center pb-10">
  ...
  editor.BlockManager.add("card-block-7", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `
...
<form class="space-y-6" action="#">
  ...
  editor.BlockManager.add("card-block-9", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `
...
<div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
  ...
  editor.BlockManager.add("card-block-14", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `
  ...
  editor.BlockManager.add("card-block-15", {
    label: `
    <i class="fa fa-square-o" style="font-size: 40px; padding:4px;"></i> Styled Block 1
  `,
    content: `

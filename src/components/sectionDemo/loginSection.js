...
const loginSection = (editor) => {
      ...
      >
        <div class="relative flex w-full flex-col pt-[20px] md:pt-0">
          ...
          >
            ...
            <label
              class="mb-3 flex cursor-pointer px-2.5 font-bold leading-none text-zinc-950 dark:text-white"
              for="name"
              >Your Name
              <p
                class="ml-1 mt-[1px] text-sm font-medium leading-none text-zinc-500 dark:text-zinc-400"
              >
                (30 characters maximum)
              </p></label
            >
            <div class="mb-8 flex flex-col md:flex-row">
              <form class="w-full" id="nameForm">
                <input
                  placeholder="Please enter your full name"
                  class="mb-2 mr-4 flex h-full w-full items-center justify-center rounded-lg border border-zinc-200 bg-white/0 px-4 py-4 text-zinc-950 outline-none dark:!border-white/10 dark:text-white md:mb-0"
                  type="text"
                  value="VBZ"
                  name="fullName"
                />
              ...
              <button
                class="whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 flex h-full max-h-full w-full items-center justify-center rounded-lg px-4 py-4 text-base font-medium md:ms-4 md:w-[300px]"
                form="nameForm"
                type="submit"
              >
                Update name
              ...
              <div
                class="mt-8 h-px w-full max-w-[90%] self-center bg-zinc-200 dark:bg-white/10 md:mt-0 md:hidden"
              ></div>
            </div>
            <p class="mb-5 px-2.5 text-red-500 md:px-9 hidden"></p>
            <label
              class="mb-3 ml-2.5 flex cursor-pointer px-2.5 font-bold leading-none text-zinc-950 dark:text-white"
              for="email"
              >Your Email
              <p
                class="ml-1 mt-[1px] text-sm font-medium leading-none text-zinc-500 dark:text-zinc-400"
            ...
            >
            <div class="mb-8 flex flex-col md:flex-row">
              <form class="w-full" id="emailForm" data-gtm-form-interact-id="0">
                <input
                  placeholder="Please enter your email"
                  class="mr-4 flex h-full max-w-full w-full items-center justify-center rounded-lg border border-zinc-200 bg-white/0 px-4 py-4 text-zinc-950 outline-none dark:!border-white/10 dark:text-white"
                  type="text"
                  value="vbz@gmail.com"
                  name="newEmail"
              ...
              <button
                class="whitespace-nowrap ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 flex h-full max-h-full w-full items-center justify-center rounded-lg px-4 py-4 text-base md:ms-4 font-medium md:w-[300px]"
                type="submit"
                form="emailForm"
              >
                Update email
  ...
  editor.BlockManager.add("my-style-block-3", {
    ...
    content: `
  <div
    class="relative m-4 rounded-lg bg-white shadow-sm"

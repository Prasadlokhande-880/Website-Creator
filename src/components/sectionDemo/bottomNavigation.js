...
const bottomNavigation = (editor) => {
  editor.BlockManager.add("BOTTOM_NAVIGATIONBAR1", {
    ...
    content: `
        ...
        `,
    category: sectionNames.BOTTOM_NAVIGATIONBAR,
  });

  editor.BlockManager.add("BOTTOM_NAVIGATIONBAR2", {
    label: `<button type="button" class="text-white bg-blue-700">Default</button>`,
    content: `
        <div class="fixed bottom-0 left-0 z-50 w-full h-16 bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600">
        <div class="grid h-full max-w-lg grid-cols-4 mx-auto font-medium">
  ...
  editor.BlockManager.add("BOTTOM_NAVIGATIONBAR3", {
    label: `<button type="button" class="text-white bg-blue-700">Default</button>`,
    content: `
 <div class="fixed z-50 w-full h-16 max-w-lg -translate-x-1/2 bg-white border border-gray-200 rounded-full bottom-4 left-1/2 dark:bg-gray-700 dark:border-gray-600">
  ...
  editor.BlockManager.add("BOTTOM_NAVIGATIONBAR4", {
    label: `<button type="button" class="text-white bg-blue-700">Default</button>`,
    content: `
  ...
  editor.BlockManager.add("BOTTOM_NAVIGATIONBAR5", {
    label: `<button type="button" class="text-white bg-blue-700">Default</button>`,
    content: `
  ...
  editor.BlockManager.add("BOTTOM_NAVIGATIONBAR6", {
    label: `<button type="button" class="text-white bg-blue-700">Default</button>`,
    content: `
  ...
  editor.BlockManager.add("BOTTOM_NAVIGATIONBAR7", {
    label: `<button type="button" class="text-white bg-blue-700">Default</button>`,
    content: `
  ...
  editor.BlockManager.add("BOTTOM_NAVIGATIONBAR8", {
    label: `<button type="button" class="text-white bg-blue-700">Default</button>`,
    content: `

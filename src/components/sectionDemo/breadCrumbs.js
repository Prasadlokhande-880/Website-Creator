...
const breadCrumbs = (editor) => {
  editor.BlockManager.add("breadCrumbs1", {
    label: ``,
    content: `
...
`,
    category: sectionNames.BREADCRUMBS,
  });

  editor.BlockManager.add("breadCrumbs2", {
    label: ``,
    content: `
...
`,
  ...
  editor.BlockManager.add("breadCrumbs3", {
    label: ``,
    content: `
...
`,
  ...
  editor.BlockManager.add("breadCrumbs4", {
    label: ``,
    content: `
